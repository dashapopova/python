...
Consider doing it instead with the in-line function sum, which facilitates a fast and readable one-line version of the function.
"""
...
#for every subject in nouns
    #choose a verb
        #choose an object in nouns
             #now print them together
